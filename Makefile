...
DEP_E2K =
DEP_E2K += $(wildcard arch/E2K/E2K*.inc)

LIBOBJ_E2K =
ifneq (,$(findstring e2k,$(CAPSTONE_ARCHS)))
	CFLAGS += -DCAPSTONE_HAS_E2K
	LIBSRC_E2K += $(wildcard arch/E2K/E2K*.c)
	LIBOBJ_E2K += $(LIBSRC_E2K:%.c=$(OBJDIR)/%.o)
endif
...
LIBOBJ += $(LIBOBJ_TRICORE) $(LIBOBJ_ALPHA) $(LIBOBJ_HPPA) $(LIBOBJ_E2K)
