...
- Support multiple hardware architectures: ARM, AArch64, Alpha, BPF, Elbrus-2000 (E2K),
  Ethereum VM, HP PA-RISC (HPPA), M68K, M680X, Mips, MOS65XX, PPC, RISC-V(rv32G/rv64G),
  SH, Sparc, SystemZ, TMS320C64X, TriCore, Webassembly, XCore and X86 (16, 32, 64).
